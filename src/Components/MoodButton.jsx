...
import AngryEmote from "./Emote/AngryEmote"
...
export default function MoodButton() {
    ...
    const Actions = [
        { id: "sad", Image: '/IMG_TODO/EMOTE/Sadd.png', label: "sad", onClick: () => { console.log('angry'); setIsopen(false) } },
        { id: "happy", Image: '/IMG_TODO/EMOTE/Happy.png', label: "happy", onClick: () => { console.log('angry'); setIsopen(false) } },
        { id: "angry", Image: '/IMG_TODO/EMOTE/Angry.png', label: "Angry", onClick: () => { console.log('angry'); setIsopen(false) } },
    ]
